...
<html lang="en">
  <head>
    ...
    <title>Product - Trainingpants</title>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      <li><a href="registreraENG.php"><span class="glyphicon glyphicon-user"></span>Registrera dig</a></li>
      <li><a href="loginENG.php"><span class="glyphicon glyphicon-log-in"></span> Logga in</a></li>
        ...
        <div class="row">
          <div class="col-md-3 col-sm-3 col xs-12">
            ...
            <div class="list-group">
              ...
              <a href="#" class="list-group-item">Size: <select name="selectsize"><option value="S">S</option>
              ...
              <a href="#" class="list-group-item">Color: <select name="selectcolor"><option value="Red">Red</option>
              <option value="green">Green</option>
              <option value="blue">Blue</option>
              </select>
              </a>
              <a href="#" class="list-group-item">Gender: <select name="selectgender">
          ...
          <div class="col-md-3 col-sm-3 col xs-12">
            <div class="thumbnail">
              ...
              <h3 class="pull-right">99 kr</h3>
                ...
                <p>You will not regret buying these pants.</p>
