        ...
        <div class="row">
          <div class="col-md-3 col-sm-3 col xs-12">
            ...
            <div class="list-group">
              <a href="#" class="list-group-item">Something:<select name="selectnogot"><option value="nogot">Något</option>
              </select>
              </a>
            </div>
          </div>
          ...
          <div class="col-md-3 col-sm-3 col xs-12">
            <div class="thumbnail">
              ...
              <h3 class="pull-right">299 kr</h3>
                <h3>Valla Service</h3>
                <p>Unique valla for your skiees</p>
